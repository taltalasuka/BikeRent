<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTools/AdminTools.Master" AutoEventWireup="true" CodeFile="main.aspx.cs" Inherits="ShopsDefault.AdminTools.Modules.AboutUs.main" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    <title>Quốc Minh - Quản Lý Giới Thiệu</title>
</asp:Content>
