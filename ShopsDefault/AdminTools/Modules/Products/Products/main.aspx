<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTools/AdminTools.Master" AutoEventWireup="true" CodeFile="main.aspx.cs" Inherits="ShopsDefault.AdminTools.Modules.Products.Products.main" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    <title>Quốc Minh - Quản Lý Sản Phẩm</title>
</asp:Content>
