<%@ Page Title="" Language="C#" MasterPageFile="~/AdminTools/AdminTools.Master" AutoEventWireup="true" CodeFile="main.aspx.cs" Inherits="ShopsDefault.AdminTools.Modules.News.Catalogs.main" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    <title>Quốc Minh - Quản Lý Nhóm Tin Tức</title>
</asp:Content>
