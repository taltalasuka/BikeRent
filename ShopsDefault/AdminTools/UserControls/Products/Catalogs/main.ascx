<%@ Control Language="C#" AutoEventWireup="true" CodeFile="main.ascx.cs" Inherits="ShopsDefault.AdminTools.UserControls.Products.Catalogs.main" %>
...
<div class="container-fluid">
    <div class="block-default">
        <div class="block-header">
            <i class="icon-grid"></i>Nhóm sản phẩm
        </div>
                ...
                <ContentTemplate>
                    ...
                    <asp:GridView ID="grv" runat="server" AutoGenerateColumns="False" AllowPaging="True" OnRowDataBound="grv_OnRowDataBound" DataKeyNames="ID_Catalog" OnRowDeleting="grv_RowDeleting" OnPageIndexChanging="grv_PageIndexChanging" CssClass="table table-default">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CatalogName" HeaderText="Tên nhóm sản phẩm" HtmlEncode="true" />
