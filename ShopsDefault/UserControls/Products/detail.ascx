                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="_line prd-amount"><strong>Số lượng:</strong> <span class="btn-amount btn_decrement"><i class="fa fa-minus"></i></span><asp:TextBox ID="txtQuantity" runat="server" class="addtocart_quantity" type="text" value="1"></asp:TextBox><span class="btn-amount btn_increment"><i class="fa fa-plus"></i></span>
                            ...
                            chiếc có sẵn</div>
                        <div>
                            <asp:Button ID="btnAddToCart" runat="server" CommandArgument='<%# Eval("ID_Product")%>' OnClientClick="checkItem(quantityVal());" OnClick="btnAddToCart_Click" CausesValidation="false" Text="Thuê xe" UseSubmitBehavior="false" CssClass="btn-default add-to-cart" />
                        </div>
                    </div>
                    <div class="col-12">
