...
namespace Librari {
	public partial class Cls_ShopsOrdersDetail
	{
		...
		/// </summary>
		public Cls_ShopsOrdersDetail(int id_orderproduct, int id_payment, int id_user, string ordersname, string username, string useremail, string useraddress, string userphone, Double pricetotal, string description, DateTime addtime, DateTime edittime, bool hidden)
		{
